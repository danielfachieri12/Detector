...
int main(int argc, char * argv[]) {
	...
	track->TransportPhoton(inR + 0.2, 0,0,0,7e3,-1,1,0, nel); //o foton inicia a 2mm de distância do fio qualé
	...
	std::cout << nel << " número de elétrons gerados" << std::endl;
